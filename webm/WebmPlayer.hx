...
{
	public static inline var BYTES_PER_SAMPLE = 4 * 8192;
	public static var BLANK_BYTES:ByteArray;
	public static var SKIP_STEP_LIMIT = 0;

	public var frameRate(default, null):Float;
	public var duration(default, null):Float;

	public var vpxDecoder:VpxDecoder;
	public var webmDecoder:Dynamic;
	public var outputSound:ByteArray;
	public var soundChannel:SoundChannel;
	public var sound:Sound;
	public var soundEnabled:Bool;
	public var skippedSteps = 0;
	
	public var startTime = 0.0;
	public var lastDecodedVideoFrame = 0.0;
	public var lastRequestedVideoFrame = 0.0;
	public var playing = false;
	public var renderedCount = 0;
	public var renderedCount2 = 0;
	public var lastDecodedVideoFrame2 = 0.0;
	public var fkingElapsed = 0.0;
